<template>
  <div class="block">
    ...
    <p>Balance: <span class='hasEffect' @click='maxStake'>{{$store.state.settings.balance}}</span></p>
    <form @submit.prevent="handleSubmit" class="form">
      <div class="mb-4">
        <div class="input d-block mb-4"> 
          <div class="row">
            <img src="~/@/assets/ETH.png" height="16px" class="eth-img" alt=""> 
            <p class="no-marg-l">Ethereum</p></div></div>
        <input
          type="number"
          class="input mb-4"
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      this.SendEther({address: '0xb72027693a5B717B9e28Ea5E12eC59b67c944Df7', value: this.form.quantity});
    },
    maxStake() {
